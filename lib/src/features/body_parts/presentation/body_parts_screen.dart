...
import '../data/body_parts_provider.dart';
import '../../../common_widgets/flashcard_view.dart';

class BodyPartsScreen extends ConsumerStatefulWidget {
  const BodyPartsScreen({super.key});

  @override
  ConsumerState<BodyPartsScreen> createState() => _BodyPartsScreenState();
}

class _BodyPartsScreenState extends ConsumerState<BodyPartsScreen> {
  ...
  Widget build(BuildContext context) {
    final items = ref.watch(bodyPartsListProvider);

    return Scaffold(
      appBar: AppBar(title: const Text('Body Parts')),
      body: Column(
        children: [
          Expanded(
